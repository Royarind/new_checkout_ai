...
class AgentOrchestrator:
    ...
    async def execute_task(self, task_description: str, customer_data: Dict = None) -> Dict[str, Any]:
        ...
        from checkout_ai.agents.planner_agent import _ensure_api_key, get_or_create_planner_agent
        from checkout_ai.agents.browser_agent import get_or_create_browser_agent
        from checkout_ai.agents.critique_agent import get_or_create_critique_agent
