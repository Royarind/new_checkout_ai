...
CONTINUE_BUTTONS = [
    ...
    'continue to payment', 'continue to billing'
]

# Buttons to AVOID clicking (negative keywords)
AVOID_BUTTONS = [
    'edit cart', 'edit', 'back', 'cancel', 'remove', 'delete'
]

# Landmark field labels
LANDMARK_LABELS = [
    'landmark', 'near', 'nearby', 'optional landmark'
]

# Same as billing checkbox labels
SAME_AS_BILLING_LABELS = [
    'same as billing', 'use as billing', 'billing same as shipping', 'copy from shipping',
    'my billing address is the same as my shipping address'
]

# Shipping method labels (for radio buttons)
SHIPPING_METHOD_LABELS = [
    'standard', 'free', 'economy', 'express', 'expedited', 'shipping method', 'delivery method'
]

# Continue to Payment button keywords
PAYMENT_BUTTONS = [
    'continue to payment', 'proceed to payment', 'go to payment', 'next: payment', 'payment'
]
