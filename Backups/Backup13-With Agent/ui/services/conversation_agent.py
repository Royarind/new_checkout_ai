...
class ConversationAgent:
    ...
    STATE_FILE = os.path.expanduser('~/.chkout_state.json')
    ...
    async def process_message(self, user_message):
        ...
        if self.state == 'CONFIRM_PROFILE':
            if user_message.lower().strip() in ['yes', 'y', 'yeah', 'yep', 'ok', 'confirm', 'correct', 'looks good']:
                ...
                self.state = 'COMPLETE'
                ai_message = "Perfect! All information confirmed. You can now click 'Click-less Checkout' to start the Checkout process, or 'Edit Details' buttons to edit the provided details."
