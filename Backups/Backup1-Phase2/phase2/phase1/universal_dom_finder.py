...
async def find_variant_dom(page: Page, variant_type: str, variant_value: str) -> Dict[str, Any]:
    ...
    debug_dir = '/Users/abcom/Documents/Test_Browser/variant_debug'
                    ...
                    result = await page.evaluate("""
                        (val) => {
                            ...
                            const searchPatterns = [
                                ...
                                { selector: '[data-value], [data-option], [data-variant], [data-size], [data-color]', action: 'click',
                                  extraCheck: (el) => {
                                      const dataAttrs = ['data-value', 'data-option', 'data-variant', 'data-size', 'data-color'];
            ...
            if result['found']:
                ...
                validated = await page.evaluate("""
                    (args) => {
                        ...
                        // Strategy 4: Check recently clicked element (marked with data-dom-el)
