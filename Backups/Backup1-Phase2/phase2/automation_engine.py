...
class WebAutomator:
    ...
    async def setup_browser(self):
        ...
        if STEALTH_AVAILABLE:
            ...
            print("Browser opened with stealth mode")
        else:
            print("Browser opened (stealth mode not available)")
...
class ProductVariantAutomator:
    ...
    async def automate_product_selection_dynamic(self, website_details: WebsiteDetails):
        ...
        try:
            ...
            if successful_selections:
                cart_result = await add_to_cart_robust(self.web_automator.page)
                ...
                if cart_result:
                    ...
                    if cart_result.get('success'):
                        ...
                        if nav_result.get('success'):
                            ...
                            print(f"⚠️  Could not navigate to cart (continuing anyway)")
                            results.append(nav_result)
                    else:
