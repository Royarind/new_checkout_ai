...
async def ai_handle_guest_checkout(page, llm_client):
    ...
    prompt = f"""Find guest checkout button.

BUTTONS:
{json.dumps(simple_btns)}

Find: "guest", "continue as guest", "checkout as guest"
