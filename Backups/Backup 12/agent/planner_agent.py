...
🚨 CRITICAL RULE - NEVER CLICK THESE BUTTONS:
- ANY button with text "Apply", "Redeem", "Add Code", "Submit" near coupon/promo/gift certificate fields
- ANY button associated with discount codes, promo codes, gift cards, or gift certificates
- These buttons trigger captchas and must be completely avoided
...
5. SKIP any buttons related to coupons, promos, gift certificates, or discount codes
