...
app.layout = dbc.Container([
    ...
    dbc.Row([
        ...
        dbc.Col([
            ...
            # Control buttons
            dbc.ButtonGroup([
                dbc.Button("✏️ Edit Details", id='quick-buy-btn', color='primary', disabled=True, style={'font-weight': '600'}),
                dbc.Button("🚀 Click-less Checkout", id='start-btn', color='success', disabled=True, style={'font-weight': '600'}),
...
def save_edited_details(n_clicks, quantity, color, size, email, firstName, lastName, phone, address, city, province, postal, json_data):
