...
# Checkout button keywords
CHECKOUT_BUTTONS = [
    'checkout', 'check out', 'proceed to checkout', 'continue to checkout',
    'go to checkout', 'secure checkout', 'proceed', 'continue',
    'proceed to cart', 'view cart', 'go to cart', 'shopping cart',
    'place order', 'complete order', 'pay now', 'payment',
    'secure payment', 'continue to payment'
]

# Guest checkout button keywords
GUEST_CHECKOUT_BUTTONS = [
    'guest checkout', 'checkout as guest', 'continue as guest', 'guest',
    'continue without account', 'skip registration', 'no account needed',
    'checkout without account', 'shop as guest'
]
...
FIRST_NAME_LABELS = [
    ...
    'first_name', 'givenname', 'name first', 'billing first name',
    'shipping first name', 'billingfirstname', 'shippingfirstname'
]

# Last name field labels
LAST_NAME_LABELS = [
    'last name', 'lastname', 'last', 'surname', 'family name', 'lname',
    'last_name', 'familyname', 'name last', 'billing last name',
    'shipping last name', 'billinglastname', 'shippinglastname'
]
